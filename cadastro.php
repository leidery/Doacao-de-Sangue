  ...
  <div class="container" id="cadastro">
      <form action="" method="post">
        ...
        <fieldset>
          ...
          <input type="text" id="nome" name="nome" class="input-only-text"><br>
        </fieldset>

        <fieldset>
        <legend for="data-nascimento">Data de Nascimento: </legend>
        <input type="date" id="data-nascimento" name="data-nascimento" class="input-only-text">
        </fieldset>
    ...
    <fieldset>
      ...
      <input type="tel" id="telefone" name="telefone" class="input-only-text" placeholder="(00) 0000-0000">
      </fieldset>
      ...
      <input type="text" id="numero" name="numero" required  class="input-only-text">
      </fieldset>
    
      <fieldset>
        <legend for="email">E-mail: </legend>
        <input type="email" id="email" name="email" class="input-only-text">
      </fieldset>

      <fieldset>
        <legend for="senha">Senha: </legend>
        <input type="password" id="password" name="senha" class="input-only-text">
      </fieldset>
    
      <fieldset>
        <legend for="confsenha">Confirmar senha: </legend>
        <input type="password" id="password" name="confsenha" class="input-only-text">
      </fieldset>

      <fieldset>
        <legend for="rg">RG: </legend>
        <input type="text" id="rg" name="rg" class="input-only-text">
      </fieldset>

      <fieldset>
        <legend for="cpf">CPF: </legend>
        <input type="text" id="cpf" name="cpf" class="input-only-text">
      </fieldset>
