...
<html lang="pt-br">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="icons/icons8-gota-de-sangue-48.png" type="image/x-icon">
    ...
    <body>
        ...
        <div class="container-md" id="cont-index">
            <h1>Seja bem-vindo à nossa plataforma!</h1>
            <div class="text-center">
                <img src="../public/img/donation.jpg" class="img-fluid rounded mx-auto d-block div-image"
            ...
            <section>
                <p>
                    ...
                    encontrar
                    facilmente hemocentros dísponiveis na cidade de <strong>Curitiba</strong> próximos a você e se
                    tornar um doador
                    de
                    sangue regular para ajudar a salvar
                    vidas.
                </p>
                <p>
                    ...
                    daqueles
                    que precisam de doações, é por isso que criamos esta plataforma, para facilitar a conexão entre
                    doadores
                    de sangue e hemocentros.
                </p>
                <div class="text-center">
                    <img src="../public/img/pessoas.jpeg" class="img-fluid rounded mx-auto d-block"
                        alt="pessoas realizando doações">
                </div>

                <h2>Quem somos</h1>
                    <p>
                        Nossa plataforma conecta doadores de sangue a hospitais e bancos de sangue que precisam de
                        doações. Através
                        deste
                        site, os doadores podem se cadastrar, agendar doações e encontrar informações sobre os
                        requisitos para doação
                        de
                        sangue, tais como idade, peso, histórico de saúde e medicações que possam afetar a doação.
                    </p>
                    <p>
                        Através deste site, a doação de sangue torna-se mais acessível e conveniente, ajudando a salvar
                        vidas e
                        melhorar
                        a
                        saúde das pessoas. Com a ajuda desta plataforma, a doação de sangue pode ser feita com maior
                        frequência e
                        eficiência, aumentando assim o número de vidas salvas.
                    </p>
                    <br>
